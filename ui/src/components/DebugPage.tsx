    ...
    <div className="h-screen bg-gray-50 font-sans">
      ...
      <header className="flex h-16 items-center justify-between border-b bg-white px-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold text-gray-800">HTTP request</h1>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        >
                          ...
                          {fullscreenEditor === 'headers' ? 'exit' : 'fullscreen'}
                  ...
                  <TabsContent value="body" className="flex-1 mt-2">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        >
                          <Maximize className="h-4 w-4 mr-1" />
                          {fullscreenEditor === 'body' ? 'exit' : 'fullscreen'}
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {responseData.status > 0 && (
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <span>
                    {/* 响应时间:  */}
                    Timestamp: <span className="font-mono">{responseData.responseTime}ms</span>
                  </span>
                </div>
              )}
            </div>
            ...
            {responseData.body ? (
              <div className="flex-1">
                <Tabs defaultValue="body" className="h-full flex flex-col">
                  <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="body">Body</TabsTrigger>
                    <TabsTrigger value="headers">Heading</TabsTrigger>
              ...
              <div className="flex-1 flex items-center justify-center text-gray-500">
                {isLoading ? 'requesting...' : 'response will be shown here'}
